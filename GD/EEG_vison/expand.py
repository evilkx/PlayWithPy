...
class Ui_expand(object):
    def setupUi(self, expand):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(70, 100, 201, 431))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.ele_eye = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.ele_eye.setCheckable(False)
        self.ele_eye.setChecked(False)
        ...
        self.img_expand = QtWidgets.QLabel(self.centralwidget)
        self.img_expand.setGeometry(QtCore.QRect(140, 40, 61, 61))
        self.img_expand.setText("")
        self.img_expand.setTextFormat(QtCore.Qt.AutoText)
        self.img_expand.setPixmap(QtGui.QPixmap("C:/Users/MI/Downloads/Puzzle.png"))
        self.img_expand.setScaledContents(True)
        self.img_expand.setObjectName("img_expand")
